...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <form id="form1" runat="server">
        ...
        <p>
            Date of Birth&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>&nbsp;<i class="fa fa-calendar"></i>
            <asp:Button ID="Button2" runat="server" Text="Request Elevated Access" style="margin-left:200px;" OnClick="Button2_Click" />
    </p>
        <p>
            Access Type&nbsp;&nbsp;&nbsp;&nbsp;
